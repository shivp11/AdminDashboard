...
<div class="row align-items-center">
    <div class="col-auto">
      <span class="avatar avatar-md" style="background-image: url(http://127.0.0.1:8000/back/dist/img/authors/AIMG1167785871510959.jpg)"></span>
    </div>
    <div class="col-md-6">
      <h2 class="page-title">Shiv Patel</h2>
      <div class="page-subtitle">
        <div class="row">
          <div class="col-auto">
            <!-- Download SVG icon from http://tabler-icons.io/i/building-skyscraper -->
            <!-- SVG icon code -->
            <a href="#" class="text-reset">@ shivp311 | Admin/Super Author</a>
          </div>
